...
class TrafikverketTest extends TestCase
{
	...
	public function can_filter_with_and(){
		$stations = Trafikverket::trainStation()
		                        ->where("AdvertisedLocationName", "LIKE", "köping")
								->where("AdvertisedShortLocationName", "Linköping")
		                        ->get();
	...
	public function can_filter_with_or(){
		$stations = Trafikverket::trainStation()
		                        ->where("AdvertisedShortLocationName" , "Katrineholm")
		                        ->orWhere("AdvertisedShortLocationName", "Linköping")
		                        ->get();
	...
	public function can_nest_filters(){
		$stations = Trafikverket::trainStation()
		                        ->where("AdvertisedLocationName", "=", "Norrköping C")
